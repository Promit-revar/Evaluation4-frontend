...
export default function CollectionCardComponent(props) {
    ...
    const onSubmitChange =()=>{
        const request={...updateCollections, url:updateCollections.url+props.content.collectionId}
        makeRequest(request,BASE_URL,{headers:{authorization:localStorage.getItem("token")},data:{data:{...editData}}})
        .then((res)=>{
            console.log(res);
    ...
    const handleDelete=()=>{
        const result={...deleteCollection,url:deleteCollection.url+props.content.collectionId};
        makeRequest(result,BASE_URL,{headers:{authorization:localStorage.getItem("token")}})
        .then((res)=>{
    ...
    return (
        ...
        <div className="collection-card">
              ...
              <div className="form">
                <div className="form-fields">
                    {Object.keys(props.content.data).map((item)=>(
                        ...
                        {item}
                        </label><br /><input type="text" defaultValue={props.content.data[item]} name={item} onChange={handleEditData} /><br/></>
            ...
            <div className="actions">
                <img src={require("../../assets/images/note.png")} alt="edit" onClick={()=>setShowModal(true)}/>
